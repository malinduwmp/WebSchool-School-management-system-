...
<head>
    ...
    <title>Manage Admin| Webschool</title>
    ...
    <div class="container-fluid">
        <div class="row g-2">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label  fw-bold fs-1" style="color:rgba(54, 19, 19, 1);">Manage All Admin</label>
            </div>
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        <div class="col-2 col-lg-2 bg-danger py-2 text-end">
                        ...
                        <div class="col-4 col-lg-3 bg-danger  py-2" onclick="viewMsgModal('<?php echo $selected_data['email']; ?>','<?php echo $x; ?>');" style="cursor: pointer;">
                        ...
                        <div class="col-2 col-lg-2 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button class="btn btn-danger" id="ab<?php echo $selected_data['email']; ?>" onclick="blockadmin('<?php echo $selected_data['email']; ?>');">Remove Admin</button>
                            <?php
                            } else {
                            ?>
                                <button class="btn btn-success" id="ab<?php echo $selected_data['email']; ?>" onclick="blockadmin('<?php echo $selected_data['email']; ?>');">Add Admin</button>
                            <?php
                            }
