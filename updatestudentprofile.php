...
<head>
    ...
    <title>Student Profile | WebSchool</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $details_rs = Database::search("SELECT * FROM `student` WHERE `email`='" . $email . "'");
                                ...
                                <div class="col-md-5 border-end">
                                    <div class="p-3 py-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="fw-bold">Student Profile Settings</h4>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <!-- email -->
                                                ...
                                                <input type="text" class=" form-control"  value="<?php echo $data["grade_id"]; ?>" />
                                            </div>
                                            <!-- grade -->
