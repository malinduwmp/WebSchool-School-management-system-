...
<head>
    ...
    <title>Teachers Home | WebSchool </title>
                    ...
                    <div class="col-12 col-lg-4 px-1">
                        <div class="row g-1">
                            <div class="col-12 bg-white text-center rounded" style="height: 200px;">
                                <br />
                                <span style="cursor: pointer;" class="fs-4 fw-bold" onclick="window.location.href='addlesson.php'">Add lesson notes</span>
                                <br />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 px-1">
                        <div class="row g-1">
                            <div class="col-12 bg-dark text-white text-center rounded" style="height: 200px;">
                                <br />
                                <span style="cursor: pointer;" class="fs-4 fw-bold" onclick="window.location.href='addassigments.php'">Add new assignments</span>
                                <br />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 px-1">
                        <div class="row g-1">
                            <div class="col-12 bg-secondary text-white text-center rounded" style="height: 200px;">
                                <br />
                                <span style="cursor: pointer;" class="fs-4 fw-bold" onclick="window.location.href='#'">View submitted answer sheets</span>
                                <br />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 px-1">
                        <div class="row g-1">
                            <div class="col-12 bg-success text-white text-center rounded" style="height: 200px;">
                                <br />
                                <span style="cursor: pointer;" class="fs-4 fw-bold" onclick="window.location.href='#'">Add assignment marks</span>
                                <br />
                            </div>
                        </div>
                    </div>
