...
<head>
    ...
    <title>Manage Student| Webschool</title>
    ...
    <div class="container-fluid">
        <div class="row g-2">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label  fw-bold fs-1" style="color:rgba(54, 19, 19, 1);">Manage All Student</label>
            </div>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button class="btn btn-danger" id="sb<?php echo $selected_data['email']; ?>" onclick="blockstudent('<?php echo $selected_data['email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button class="btn btn-success" id="sb<?php echo $selected_data['email']; ?>" onclick="blockstudent('<?php echo $selected_data['email']; ?>');">Unblock</button>
                            <?php
                            }
