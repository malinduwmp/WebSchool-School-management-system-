...
if(isset($_POST["sre"])&& isset($_POST["srp"])){
    ...
    if(empty($sendmail)){
        ...
        $rs = Database::search("SELECT * FROM `student` WHERE `email`='".$sendmail."'");
        $n = $rs->num_rows;
        ...
        if($n > 0){
            ...
            (`email`,`password`,`grade_id`) VALUES
            ('".$sendmail."','".$sendpass.",".$grade."')");
