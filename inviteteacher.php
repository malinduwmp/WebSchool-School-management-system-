...
<head>
    ...
    <title>Invite Teacher| webschool</title>
            ...
            <!-- send invite box -->
             <div class="col-12 col-lg-6 box " id="logInbox">
                <div class="row g-2">
                    ...
                    <div class="col-12">
                        <p style="color: white; font-size: 20px; ">Invite Teacher </p>
                    </div>
                    ...
                    <div class="margin col-12">
                        ...
                        <input type="email" class="form-control " id="tse" placeholder="Enter The Teachers Send Email here" />
                    </div>

                    <div class="col-12 " style="color: white;">
                        <lable class="form-lable">Password</lable>
                        <input type="password" placeholder="Enter The Teachers Send password here" class="form-control" id="tsp" />
                    </div>


                    <div class="col-12"  >
                        <button class="col-12 btn btn-primary bg-danger" onclick="teachersend();">Send</button>
                    </div>
                </div>
